...
app = Flask(__name__)
app.secret_key = os.getenv("SECRET_KEY", "supersecretkey")  # For flash messages

# Database configuration (Supabase PostgreSQL)
app.config["SQLALCHEMY_DATABASE_URI"] = os.getenv(
    "DATABASE_URL",
    "postgresql://postgres:YOUR_PASSWORD@db.pxhdnchpnyjmmxyylzfx.supabase.co:5432/tournament_db"
)
